...
class lista_circular:
    ...
    def modificador(self, paciente, fecha_cita, hora_cita, nuevo_tratamiento):
        actual = self.primero
        no_encontrado = False
...
lista_c.modificador('Gerson Lopez', '22-02-2023', '15:30', '1 pastilla de Tilenol cada 24 horas')
lista_c.recorrer()